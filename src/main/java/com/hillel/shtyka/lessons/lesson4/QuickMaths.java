...
public class QuickMaths
{
    public static void main(String[] args)
    {
        ...
        System.out.println("Введіть довжини ребер 1, 2 основи, другого ребра 3 бічної грані, " +
                "значення кута 4 між ребрами основи та кута 5 між площиною основи та ребром бічної грані \n" +
                "(для прямокутного паралелепіпеда - всі кути 90\u00B0), розділяючи аргументи пробілом (\" \") ");
        ...
        System.out.println("Вхідні дані: паралелепіпед зі сторонами " + params[0] + ", " + params[1] + " основи та кутом " +
                ...
                "Сума довжин всіх ребер паралелепіпеда: " + length + "; об'єм паралелепіпеда: " + volume);
    }
